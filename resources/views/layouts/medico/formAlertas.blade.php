...
@section('content')
        ...
        <div class="card">
            <div class="card-header">Tens a certeza que desejas apagar os dados de: <span class="font-weight-bold text-secondary">{{ $medico->nome }}</span></div>
            <div class="card-body">
                <form action="{{ route('apagarMed', $medico->id) }}}" method="post">
                    @csrf
                    <div class="row">
