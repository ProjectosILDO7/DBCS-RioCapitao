...
@section('content')
        ...
        <div class="card">
            <div class="card-header">Tens a certeza que desejas apagar: <span class="font-weight-bold text-secondary">{{ $esp->nome_especialidade }}</span></div>
            <div class="card-body">
                <form action="{{ route('apagarEsp', $esp->id) }}}" method="post">
                    @csrf
                    <div class="row">
